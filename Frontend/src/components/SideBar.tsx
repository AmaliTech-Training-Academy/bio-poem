  ...
  return (
    <div className='min-h-screen border-r border-gray-400 border-r-1 md:px-4 xl:pr-14 pl-6 pt-10 pb-4 w-3/12' id='sidebar'>
        ...
        <div className='text-2xl font-normal mt-[114px] w-fit m-auto'>
            ...
            >
                    <LiaHomeSolid className='md:ml-3 xl:ml-5'/> <p className='md:ml-5 ml-11'>Home</p>
                </div>
            </NavLink>
            <div className={`flex items-center my-[55px] cursor-pointer`}
                >
                <BiSearchAlt2 className='md:ml-3 ml-5'/><p className='md:ml-5 ml-11'>Search</p>
            </div>
            <NavLink to={'/create'}>
                <div className={`flex items-center cursor-pointer`}
                    >
                    <BiFolderPlus className='md:ml-3 ml-5'/><p className='md:ml-5 ml-11'>Create Poem</p >
                </div>
            </NavLink>
        </div>
