...
const Header: React.FC<headText> = ({text1}) => {
  // const openSearch = useAppSelector((state)=>state.search.openSearch)
  return (
    <div className={`flex border-2 border-[#D9D9D9] justify-between rounded-lg mt-8 ml-8 relative p-5`}>
        <div className='absolute left-[5%] bottom-[35%]'>
            <h1 className='font-semibold text-xl lg:text-4xl'>{text1}</h1>
